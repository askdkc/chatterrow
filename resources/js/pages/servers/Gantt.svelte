<script lang="ts">
    ...
    import { ArrowLeft, CalendarRange, Hash, CheckCircle2 } from 'lucide-svelte';
    ...
    <main class="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div class="min-h-0 flex-1 overflow-auto">
            ...
            >
                ...
                <div class="sticky left-0 top-0 z-20 flex h-10 items-center border-b border-r border-black/10 bg-[#2b2d31] px-3 text-xs font-semibold text-[#80848e]">
                    タスク
                </div>
                ...
                {#each tasks as task (task.id)}
                        ...
                        >
                            {#if task.type === 'channel'}
                                <span class="flex items-center gap-1">
                                    <Hash class="h-3 w-3 shrink-0 text-[#80848e]" />
                    ...
                    {:else}
                        <div class="min-h-10 border-b border-l border-black/10"></div>
                    {/if}
                {/each}
            </div>
        </div>
